...
def calc_pairwise_cosine_similarity(feat):
    #في الكود الأول: الدالة تفترض أن المدخل feat هو دائماً من نوع torch.Tensor. إذا استقبلت المصفوفة بصيغة numpy  سيتوقف البرنامج لأن NumPy لا يملك خاصية .norm().هذا السطر يجعل الكود مرناً؛ فإذا كانت البيانات قادمة من مكتبة NumPy، يقوم بتحويلها تلقائياً إلى Torch Tensor قبل البدء بالحسابات، مما يمنع حدوث الـ AttributeError.
     # تحويل numpy إلى torch إذا لزم
